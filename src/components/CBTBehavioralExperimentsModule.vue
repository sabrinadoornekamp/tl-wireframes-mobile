          ...
          <div class="wireframe-section-content">
            <div class="wireframe-learning-content">
              <div class="wireframe-content-text">
                ...
                <ul>
                  <li>Design experiments to test your beliefs and assumptions</li>
                  <li>Learn to gather evidence through real-world testing</li>
                  <li>Practice hypothesis testing for your thoughts</li>
                  <li>Develop confidence through behavioral change</li>
                </ul>
                
                <h3>Conducting Effective Experiments</h3>
                <p>This module teaches you how to design and conduct behavioral experiments to test your thoughts and beliefs in real-world situations. You'll learn to formulate testable hypotheses, gather evidence, and use the results to challenge unhelpful beliefs. These experiments help you build confidence and develop more accurate thinking patterns.</p>
                
                <div class="wireframe-examples">
                  <h4>Behavioral Experiment Examples</h4>
                  <div class="wireframe-example-item">Test: "If I speak up, people will reject me" → Experiment: Share opinion in safe setting</div>
                  <div class="wireframe-example-item">Hypothesis: "I can't handle criticism" → Test: Ask for feedback on a project</div>
                  <div class="wireframe-example-item">Belief: "I'm not creative" → Experiment: Try a new creative activity</div>
                </div>
              </div>
            </div>
          </div>
...
const currentModuleData = ref({
  ...
  description: 'Design and conduct behavioral experiments to test your thoughts and beliefs in real-world situations.',
  duration: '75 minutes',
  progress: 100
})
