<template>
  <div class="wireframe-therapieland-overview">
    <div class="wireframe-header">
      <div class="wireframe-title">My therapieland</div>
...
<style scoped>
/* Wireframe Therapieland Overview Styles */
.wireframe-therapieland-overview {
  padding: 24px;
  min-height: 100vh;
  max-width: 1280px;
  margin: 0 auto;
