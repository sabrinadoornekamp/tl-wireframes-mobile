          ...
          <div class="wireframe-section-content">
            <div class="wireframe-learning-content">
              <div class="wireframe-content-text">
                ...
                <ul>
                  <li>Identify early warning signs of setbacks</li>
                  <li>Develop personalized coping strategies</li>
                  <li>Create a support network and safety plan</li>
                  <li>Learn to maintain progress long-term</li>
                </ul>
                
                <h3>Maintaining Your Progress</h3>
                <p>This module focuses on strategies to maintain your mental health progress and prevent relapses. You'll learn to recognize early warning signs, develop personalized coping strategies, and create a comprehensive plan for long-term well-being. These skills help you build resilience and maintain the gains you've made through therapy.</p>
                
                <div class="wireframe-examples">
                  <h4>Relapse Prevention Examples</h4>
                  <div class="wireframe-example-item">Warning sign: Increased negative self-talk → Action: Use thought challenging techniques</div>
                  <div class="wireframe-example-item">Trigger: Stressful work situation → Coping: Practice relaxation techniques</div>
                  <div class="wireframe-example-item">Setback: Feeling overwhelmed → Plan: Reach out to support network</div>
                </div>
              </div>
            </div>
          </div>
